...
def handle_data(context, data):
    ...
    #short_data.loc[:,'tp'] = (short_data.high + short_data.low + short_data.close)/3
    #cci = (short_data.iloc[-1].tp - short_data[-15:-1].tp.mean())/0.015/short_data[-15:-1].tp.mad()
...
if __name__ == '__main__':
    run_algorithm(
        ...
        end=pd.to_datetime('2017-01-10', utc=True),
    )